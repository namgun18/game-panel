...
class Settings(BaseSettings):
    ...
    app_url: str = "https://game.namgun.or.kr"
    debug: bool = False
    ...
    admin_email: str = "admin@namgun.or.kr"
    ...
    discord_redirect_uri: str = "https://game.namgun.or.kr/api/auth/discord/callback"
    discord_guild_id: str = ""        # 기완님의 비공개 디스코드 서버 ID
